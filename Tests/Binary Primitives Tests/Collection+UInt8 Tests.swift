...
/// Tests for Collection<UInt8> extensions - uses parallel namespace pattern
/// since these are protocol extensions.
@Suite("Collection+UInt8")
struct CollectionUInt8Tests {
    @Suite struct Unit {}
...
extension CollectionUInt8Tests.Unit {
    ...
    @Test
    func `firstIndex of subsequence`() {
...
extension CollectionUInt8Tests.EdgeCase {
    ...
    @Test
    func `lastIndex empty needle returns endIndex`() {
        let data: [UInt8] = [1, 2, 3]
