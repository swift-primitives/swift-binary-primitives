...
@Suite("UInt64 - Byte encoding")
struct UInt64ByteEncodingTests {
    @Suite struct Unit {}
...
extension UInt64ByteEncodingTests.Unit {
    ...
    func `decode-encode isomorphism`() {
        // decode ∘ encode ≡ id
        let originalBytes: [UInt8] = [0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0]
